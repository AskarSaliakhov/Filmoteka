<template>
    <div class="ChooseFormat">
        <div class="container">
            <p id="title">Выберите какой формат теста хотите пройти</p>
            <div class="modals">
                <div class="description__king">
                    <p id="title--format">Турнир: Царь горы</p>
                    <ul>
                    ...
                    <div class="buttons">
                        <button
                            id="btn--king"
                            @click="redirectToKing"
                        >
                            Выбрать "Царь горы"
                        </button>
                    </div>
                </div>
                <div class="description__play__offs">
                    ...
                    <ul>
                        ...
                        <li>Таким образом каждый этап отсеивает половину вариантов, пока не останется один -
                            победитель;
                        </li>
                    </ul>
                    <div class="buttons">
